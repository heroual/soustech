...
const ProjectsGallery = () => {
  ...
  const projects = [
    {
      id: 1,
      title: "Villa Prestigieuse - Smart Home Complète",
      category: "Smart Home",
      location: "Anfa, Casablanca",
      date: "Décembre 2023",
      duration: "3 jours",
      client: "Famille Benani",
      description: "Installation complète de domotique dans une villa de 300m² avec gestion éclairage, chauffage, volets et sécurité.",
    ...
    {
      id: 2,
      title: "Siège Social - FTTR & Réseau",
      category: "FTTR + Réseaux",
      location: "Technopolis, Rabat",
      date: "Novembre 2023",
      duration: "2 jours",
      client: "Maroc Connect SA",
      description: "Déploiement FTTR et infrastructure réseau pour 250 postes de travail avec Wi-Fi 6E professionnel.",
    ...
    {
      id: 3,
      title: "Restaurant Gastronomique - Système Sécurité",
      category: "Sécurité",
      location: "Guéliz, Marrakech",
      date: "Octobre 2023",
      duration: "1 jour",
      client: "Le Jardin Secret",
      description: "Installation système de surveillance intelligent avec 15 caméras 4K et détection IA pour sécuriser l'établissement.",
      features: ["15 caméras 4K", "Détection de mouvement IA", "Accès mobile", "Stockage cloud sécurisé"],
      image: "🍽️",
    ...
    {
      id: 4,
      title: "Riad Traditionnel - FTTR Invisible",
      category: "FTTR",
      location: "Médina, Fès",
      date: "Septembre 2023",
      duration: "1 jour",
      client: "Dar El Bacha",
      description: "Installation FTTR invisible dans un riad traditionnel sans perçage, préservant l'authenticité.",
      features: ["Installation sans perçage", "Câblage invisible", "10 prises FTTR", "Débit symétrique 1 Gbit/s"],
      image: "🏛️",
    ...
    {
      id: 5,
      title: "Café Littéraire - IoT & Wi-Fi",
      category: "IoT",
      location: "Agdal, Rabat",
      date: "Août 2023",
      duration: "2 jours",
      client: "Café des Lumières",
    ...
    {
      id: 6,
      title: "Complexe Résidentiel - Écosystème Complet",
      category: "Smart Home",
      location: "Palmorie, Tanger",
      date: "Juillet 2023",
      duration: "4 jours",
      client: "Résidence Al Amal",
      description: "Écosystème domotique complet avec FTTR, Smart Home, sécurité et gestion énergétique intelligente pour 10 villas.",
